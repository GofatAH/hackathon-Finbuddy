...
const quickReplies = [
  ...
  { icon: Film, label: 'Fun', template: 'Entertainment $', color: 'text-purple-500' },
                ...
                {quickReplies.map((reply, index) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className="flex items-center gap-1 px-2 py-1 bg-card hover:bg-muted/50 rounded-full border border-border/40 transition-colors"
                    >
                      <Icon className={cn("w-3 h-3", reply.color)} />
        ...
        <div className="flex items-end gap-1.5">
          ...
          <motion.div whileTap={{ scale: 0.9 }}>
            <Button
              ...
              className={cn(
                "shrink-0 text-muted-foreground hover:text-foreground hover:bg-muted/50 rounded-lg h-9 w-9 transition-all duration-200",
          ...
          <div className="flex-1 relative">
            <div className={cn(
              ...
              isFocused 
                ? "border-primary/40 bg-background shadow-[0_0_0_2px_hsl(var(--primary)/0.1)]" 
              ...
              <textarea
                ...
                rows={1}
                className={cn(
                  'w-full bg-transparent px-3 py-2 text-sm resize-none focus:outline-none placeholder:text-muted-foreground/60 transition-all duration-200',
          ...
          >
            <Button
              ...
              size="icon"
              className={cn(
                "shrink-0 rounded-lg h-9 w-9 transition-all duration-300",
                message.trim() 
